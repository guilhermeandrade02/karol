...
<div class="beauty-carousel"> <br> <br> <br>
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <img src="{{ asset('images/banner/banner1.png') }}" alt="Banner 1" class="slide-img">
        ...
        <!-- Slide 3 - Com background-position top center -->
        <div class="swiper-slide">
            <img src="{{ asset('images/banner/glute2.png') }}" alt="Banner 1" class="slide-img">
            <div class="slide-content" data-aos="fade-right"> </div>
        </div>
    ...
    <section id="about" class=" watermark-bg" data-aos="fade-up">
        <div class="container">
            <div class="grid-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="bio-container">
                        ...
                        <div class="bio-content">
                            ...
                            <p>Acredito que a beleza reside nos detalhes e que pequenos ajustes podem fazer uma grande
                                ...
                                Comprometo-me completamente em oferecer um atendimento de excelência, com muita
                                dedicação e
                                cuidado!</p>
                        </div>
                    </div>
                ...
                <div class="grid-item ">
                    <img class="imagem-arredondada-topo" src="{{ asset('images/karol.jpg') }}"
                ...
                <div class="service-card">
                    <div class="service-inner">
                        <div class="service-front service-image">
                            <img src="{{ asset('images/tratamentos/estimulo-colágeno.jpg') }}"
                ...
                <div class="product-card">
                    ...
                    <div>
                        <a href="https://wa.me/5541999632542?text=Olá, gostaria de comprar um produto."
                            target="_blank" class="whatsapp-float" aria-label="QUERO COMPRAR UM PRODUTO">
