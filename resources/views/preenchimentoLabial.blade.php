...
<section class="section-padding" data-aos="fade-up">
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-6">
                <p class="lead">
                    O preenchimento labial é um procedimento estético que visa aumentar o volume, definir o formato e
                    melhorar a simetria dos lábios, utilizando ácido hialurônico de alta qualidade para resultados
                    naturais e harmoniosos.
                </p>
                <p>
                    Nossos especialistas realizam uma avaliação personalizada para entender suas expectativas e criar um
                    plano de tratamento que valorize sua beleza natural, garantindo lábios mais volumosos, definidos e
                    com contorno perfeito.
                </p>
