...
@media (max-width: 768px) {
  ...
  .imagem-arredondada-topo {
    width: 80%;
    margin: 0 auto 30px auto; /* Centraliza a imagem */
    border-radius: 20px 20px 0 0; /* Reduz o arredondamento */
  }
    ...
    <div class="container">
        ...
        <div class="services-grid">
            ...
            <div class="service-card">
                <div class="service-inner">
                    <div class="service-front service-image">
                        <img src="https://7thbeautylab.com.br/wp-content/uploads/2024/07/olheiras.jpg" alt="Botox">
                    </div>
                    <div class="service-back">
